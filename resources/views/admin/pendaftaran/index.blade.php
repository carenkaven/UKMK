    ...
    <div class="d-none d-print-block">
        ...
        <div class="text-center mb-4">
            <h4
                ...
                LAPORAN DATA PENDAFTARAN UKM</h4>
        </div>
    </div>
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 10px; font-family: 'Times New Roman', Times, serif; font-size: 12px; color: black;">
            <thead>
                <tr>
                    ...
                    <th style="border: 1px solid #000; padding: 6px 8px; background-color: #f0f0f0; text-align: center; font-weight: bold; color: black;">Nama Atlet</th>
                    ...
                    <th style="border: 1px solid #000; padding: 6px 8px; background-color: #f0f0f0; text-align: center; font-weight: bold; width: 15%; color: black;">UKM Pilihan</th>
                    <th style="border: 1px solid #000; padding: 6px 8px; background-color: #f0f0f0; text-align: center; font-weight: bold; width: 10%; color: black;">Status</th>
                </tr>
            </thead>
            <tbody>
                @foreach($pendaftarans as $key => $data)
                    <tr>
                        ...
                        <td style="border: 1px solid #000; padding: 6px 8px; color: black;">{{ $data->mahasiswa->nama }}</td>
                        <td style="border: 1px solid #000; padding: 6px 8px; text-align: center; color: black;">{{ $data->mahasiswa->nim }}</td>
                        <td style="border: 1px solid #000; padding: 6px 8px; color: black;">{{ $data->mahasiswa->prodi }}</td>
                        <td style="border: 1px solid #000; padding: 6px 8px; color: black;">{{ $data->ukm->nama_ukm }}</td>
                        <td style="border: 1px solid #000; padding: 6px 8px; text-align: center; font-weight: bold; color: black;">
