            ...
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-header bg-white py-3 border-bottom-0">
                    <div class="d-flex align-items-center justify-content-between">
                        <h5 class="mb-0 fw-bold">Tambah UKM Baru</h5>
                ...
                <div class="card-body p-4">
                    <form action="{{ route('admin.ukm.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" name="ketua_ukm" class="form-control" id="ketua_ukm"
                                        placeholder="Ketua UKM" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" name="jadwal" class="form-control" id="jadwal" placeholder="Jadwal">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    ...
                                    <label for="kontak">Kontak (WhatsApp/Telp)</label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="card bg-light border-dashed h-100">
                                    <div class="card-body d-flex align-items-center p-2">
                                        <div class="w-100">
                                            <label class="form-label fs-7 fw-medium text-muted mb-1 ms-1">Gambar UKM</label>
