    ...
    <div class="d-none d-print-block">
        ...
        <div class="text-center mb-4">
            <h4
                ...
                LAPORAN DATA UNIT KEGIATAN MAHASISWA (UKM)</h4>
        </div>
    </div>
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 10px; font-family: 'Times New Roman', Times, serif; font-size: 12px; color: black;">
            <thead>
                <tr>
                    ...
                    <th style="border: 1px solid #000; padding: 6px 8px; background-color: #f0f0f0; text-align: center; font-weight: bold; width: 10%; color: black;">Gambar</th>
                    <th style="border: 1px solid #000; padding: 6px 8px; background-color: #f0f0f0; text-align: center; font-weight: bold; color: black;">Nama UKM</th>
                    <th style="border: 1px solid #000; padding: 6px 8px; background-color: #f0f0f0; text-align: center; font-weight: bold; color: black;">Ketua UKM</th>
                    <th style="border: 1px solid #000; padding: 6px 8px; background-color: #f0f0f0; text-align: center; font-weight: bold; width: 20%; color: black;">Jadwal</th>
                    <th style="border: 1px solid #000; padding: 6px 8px; background-color: #f0f0f0; text-align: center; font-weight: bold; width: 15%; color: black;">Kontak</th>
                </tr>
            </thead>
            <tbody>
                @foreach($ukms as $key => $ukm)
                    <tr>
                        ...
                        <td style="border: 1px solid #000; padding: 6px 8px; text-align: center; vertical-align: middle;">
                             @if($ukm->gambar)
                                <img src="{{ asset($ukm->gambar) }}" alt="Img" style="width: 40px; height: 40px; object-fit: cover; border: 1px solid #ccc;">
                            @else
                                -
                            @endif
                        </td>
                        <td style="border: 1px solid #000; padding: 6px 8px; color: black;">{{ $ukm->nama_ukm }}</td>
                        <td style="border: 1px solid #000; padding: 6px 8px; color: black;">{{ $ukm->ketua_ukm }}</td>
                        <td style="border: 1px solid #000; padding: 6px 8px; color: black;">{{ $ukm->jadwal ?? '-' }}</td>
                        <td style="border: 1px solid #000; padding: 6px 8px; color: black;">{{ $ukm->kontak ?? '-' }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
