            ...
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-header bg-white py-3 border-bottom-0">
                    <div class="d-flex align-items-center justify-content-between">
                        <h5 class="mb-0 fw-bold">Edit Sub Kriteria</h5>
                ...
                <div class="card-body p-4">
                    <form action="{{ route('admin.subkriteria.update', $subkriteria->id_sub_kriteria) }}" method="POST">
                        ...
                        <div class="vstack gap-3">
                            ...
                            <div class="form-floating">
                                <input type="text" name="nama_sub" value="{{ $subkriteria->nama_sub }}" class="form-control"
                                    id="nama_sub" placeholder="Nama Sub Kriteria" required>
                                <label for="nama_sub">Nama Sub Kriteria</label>
                            </div>

                            <div class="form-floating">
                                <input type="number" name="nilai" value="{{ $subkriteria->nilai }}" class="form-control"
                                    id="nilai" placeholder="Nilai" required>
